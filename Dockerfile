...
LABEL maintainer="chengli.zou <chengli.zou@gmail.com>" version="7.3.1"
...
&& curl -o ${AGENT_PATH}/${AGENT_FILENAME}  https://github.com/zouchengli/docker-confluence/releases/download/v${AGENT_VERSION}/atlassian-agent.jar -L \
